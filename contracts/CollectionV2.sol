...
contract CollectionV2 is Initializable, ERC1155Upgradeable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    function burn(uint256 tokenId) external {
        require(balanceOf(msg.sender, tokenId) != 0, "Collection: you mist own the NFT");
